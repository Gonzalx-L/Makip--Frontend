        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex items-start space-x-2 pt-2">
            ...
            <label htmlFor="terms" className="text-sm text-gray-700">
              Acepto los{' '}
              <Link to="/terms" className="font-medium text-teal-600 hover:text-teal-500 transition-colors duration-200">
                términos y condiciones
              </Link>
              {' '}y la{' '}
              <Link to="/privacy" className="font-medium text-teal-600 hover:text-teal-500 transition-colors duration-200">
