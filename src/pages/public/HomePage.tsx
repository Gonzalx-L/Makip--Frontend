...
const HomePage: React.FC = () => {
  return (
    <div className="homepage">
      {/* Hero Section */}
      <section className="bg-gradient-to-r from-teal-500 via-teal-600 to-teal-100 text-white py-12 md:py-20 min-h-[400px] md:min-h-[500px]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-8 md:gap-12">
            ...
            <div className="flex-1 text-center lg:text-left">
              ...
              <p className="text-lg sm:text-xl lg:text-2xl mb-6 md:mb-8 text-purple-100 leading-relaxed max-w-2xl mx-auto lg:mx-0">
              ...
              <div className="flex flex-col sm:flex-row gap-3 md:gap-4 justify-center lg:justify-start">
                <Link 
                  to="/productos" 
                  className="bg-white text-teal-700 px-6 md:px-8 py-3 md:py-4 rounded-xl font-bold text-base md:text-lg hover:bg-purple-50 transition-all duration-300 transform hover:scale-105 shadow-lg text-center"
                >
                  Ver Productos
                </Link>
                <Link 
                  to="/nosotros" 
                  className="border-2 border-white text-white px-6 md:px-8 py-3 md:py-4 rounded-xl font-bold text-base md:text-lg hover:bg-white hover:text-teal-700 transition-all duration-300 transform hover:scale-105 text-center"
                >
                  Conoce más
                </Link>
              </div>
            ...
            <div className="flex-1 max-w-lg w-full lg:w-auto">
              <div className="bg-white bg-opacity-10 backdrop-blur-sm rounded-2xl p-4 md:p-8 text-center">
                <div className="w-full h-60 md:h-80 bg-white bg-opacity-20 rounded-xl flex items-center justify-center mb-4">
                  <img 
      ...
      <section className="bg-gray-50 py-12 md:py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8 md:mb-12">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-3 md:mb-4">Productos Destacados</h2>
            <p className="text-base md:text-lg text-gray-600 max-w-2xl mx-auto px-4">Los productos más populares de nuestra tienda</p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            ...
            <div className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300 group">
              ...
              <div className="p-4 sm:p-6">
                <h3 className="text-lg sm:text-xl font-semibold text-gray-900 mb-2">APLIQUE PERSONALIZADA</h3>
                <p className="text-sm sm:text-base text-gray-600 mb-4 line-clamp-2">
                  Aplique personalizada con el diseño que desees.
                </p>
                <div className="flex items-center justify-between">
                  <span className="text-xl sm:text-2xl font-bold text-teal-500">S/15.00</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300 group">
              ...
              <div className="p-4 sm:p-6">
                <h3 className="text-lg sm:text-xl font-semibold text-gray-900 mb-2">VINIL TEXTIL</h3>
                <p className="text-sm sm:text-base text-gray-600 mb-4 line-clamp-2">
                  Vinil textil para personalizar tus prendas favoritas.
                </p>
                <div className="flex items-center justify-between">
                  <span className="text-xl sm:text-2xl font-bold text-teal-500">S/10.00</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-8 md:gap-12 items-center">
            ...
            <div className="space-y-6 md:space-y-8 order-1 lg:order-2">
              <div>
                <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 mb-4 md:mb-6 leading-tight text-center lg:text-left">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6">
                {/* Envío Rápido */}
                <div className="group p-3 md:p-4 rounded-xl hover:bg-gradient-to-br hover:from-cyan-100 hover:to-indigo-50 transition-all duration-300 hover:shadow-lg">
                  <div className="flex items-start space-x-3 md:space-x-4">
                    <div className="flex-shrink-0">
                      <div className="w-10 md:w-12 h-10 md:h-12 bg-gradient-to-br from-teal-500 to-teal-600 rounded-xl flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300">
                        <i className="fas fa-shipping-fast text-white text-sm md:text-lg"></i>
                      </div>
                    </div>
                    <div>
                      <h3 className="font-semibold text-gray-900 mb-1 group-hover:text-teal-600 transition-colors text-sm md:text-base">Envío Rápido</h3>
                      <p className="text-gray-600 text-xs md:text-sm">Entrega en 24-48 horas</p>
                    </div>
                  </div>
                </div>
      ...
      {/* Call to Action */}
      <section className="relative py-12 md:py-20 bg-gradient-to-br from-teal-300 via-teal-600 to-teal-200 overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="space-y-6 md:space-y-8">
            ...
            <div className="space-y-3 md:space-y-4">
              ...
              <p className="text-lg sm:text-xl md:text-2xl text-purple-100 max-w-3xl mx-auto leading-relaxed px-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 md:gap-8 my-8 md:my-12">
              <div className="text-center">
                <div className="text-2xl sm:text-3xl md:text-4xl font-bold text-green-400 mb-2">1000+</div>
                <div className="text-purple-200 text-sm md:text-base">Clientes felices</div>
              </div>
              <div className="text-center">
                <div className="text-2xl sm:text-3xl md:text-4xl font-bold text-cyan-400 mb-2">24h</div>
                <div className="text-purple-200 text-sm md:text-base">Envío rápido</div>
              </div>
              <div className="text-center">
                <div className="text-2xl sm:text-3xl md:text-4xl font-bold text-blue-500 mb-2">100%</div>
                <div className="text-purple-200 text-sm md:text-base">Garantizado</div>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 md:gap-6 justify-center items-center px-4">
              <Link 
                to="/login" 
                className="group inline-flex items-center justify-center px-6 md:px-8 py-3 md:py-4 border-2 border-white text-white font-bold text-base md:text-lg rounded-2xl hover:bg-white hover:text-teal-900 transition-all duration-300 transform hover:scale-105 hover:shadow-2xl min-w-[180px] md:min-w-[200px] w-full sm:w-auto"
              >
                Iniciar sesión
